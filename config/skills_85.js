...
module.exports = {
	...
	0: { // Warrior
		...
		29: { // Blade Draw
			'*': { hasChains: true },
			0: {
				noInterrupt: [1, 2, 3, 4, 5, 8, 9, 10, 11, 12, 13, '16-0', 18, '19-0', 21, 22, 23, 27, 29, 30, 31, 34, 35, 36, 37, 38, 41, 42],
	...
	6: { // Priest
		...
		32: { // Divine Prayer
			0: { length: 2200.0, fixedSpeed: true, abnormals: { 805800: { disableSkill: true } } }
		},
		33: { // Ishara's Lulliby
			'*': {
				fixedSpeed: true,
